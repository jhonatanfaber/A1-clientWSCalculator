 ...
 * 
 */
@WebServiceClient(name = "calc", targetNamespace = "http://pack/", wsdlLocation = "http://localhost:8080/calc/calc?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALC_QNAME = new QName("http://pack/", "calc");
    ...
    public Calc getCalcPort() {
        return super.getPort(new QName("http://pack/", "calcPort"), Calc.class);
    }
    ...
    public Calc getCalcPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://pack/", "calcPort"), Calc.class, features);
    }
